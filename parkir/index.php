...
<body>
    ...
    <!-- Page Content -->
    <div class="container">
    <center><h3 class="mt-4">PASAR CIKARANG</h3></center>
    <center><p>Setiap Hari Pukul 06:00 Wib - 21:00 Wib</p></center>
        
        <h3 class="mt-4">Daftar Parkir Kendaraan    
        </h3>

        <form action="index.php" method="get">
            <div class="input-group">
                <input type="text" class="form-control" placeholder="Cari Kendaraan.." name="cari" id="cari" class ="btn-primary">
